...
#       temporary focusing, currentDirectory, currentWorkingDirectory
#
...
# Stop when "xeli" is available and "xeli" is needed
# Use "xeli" to evaluate temporary variables properly.
eval "set -- $(
